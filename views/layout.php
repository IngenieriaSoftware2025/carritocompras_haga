                ...
                <ul class="navbar-nav me-auto mb-2 mb-lg-0" style="margin: 0;">
                    ...
                    <div class="nav-item dropdown " >
                        ...
                        <ul class="dropdown-menu  dropdown-menu-dark "id="dropwdownRevision" style="margin: 0;">
                            <li>
                                <a class="dropdown-item nav-link text-white " href="/carritocompras/productos"><i class="ms-lg-0 ms-2 bi bi-box me-2"></i>Gestión de Productos</a>
                            </li>
                            <li>
                                <a class="dropdown-item nav-link text-white " href="#"><i class="ms-lg-0 ms-2 bi bi-people me-2"></i>Clientes</a>
                            </li>
                            <li>
